...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		PROT_USERS, MEDIATOOLBAR, PASSWORD, SKIPLIST_SEARCH, SKIP_MSG_01, SKIP_MSG_02, SKIP_MSG_03,
		STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		BOLD_AUTHOR_MESS, HUB_SLOTS, REMOVE_FORBIDDEN, 
		...
		DUPE_COLOR, SEND_BLOOM, USE_CDM, LANG_SWITCH, EXPAND_DEFAULT, 
		SHARE_SKIPLIST_USE_REGEXP, DOWNLOAD_SKIPLIST_USE_REGEXP, HIGHEST_PRIORITY_USE_REGEXP, PROTECTED_USE_REGEXP,
		...
		AUTO_ADD_SOURCE, KEEP_FINISHED_FILES, ALLOW_NAT_TRAVERSAL, USE_EXPLORER_THEME,
		INT_LAST };
