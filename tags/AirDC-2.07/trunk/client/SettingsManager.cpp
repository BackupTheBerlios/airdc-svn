...
const string SettingsManager::settingTags[] =
{
	...
	"ProtectedUsers", "MediaToolbar", "password", "skiplistSearch", "skipMsg1", "skipMsg2", "skipMsg3",
	...
	"UseCDM", "LangSwitch", "ExpandDefault",
	"ShareSkiplistUseRegexp", "DownloadSkiplistUseRegexp", "HighestPriorityUseRegexp", "ProtectedUseRegexp",
	...
	"AutoAddSource", "KeepFinishedFiles", "AllowNATTraversal", "UseExplorerTheme",
	"SENTRY",
	// Int64
...
SettingsManager::SettingsManager()
{
	...
	setDefault(TOOLBAR, "0,-1,1,2,-1,3,4,5,-1,6,7,8,9,-1,10,11,12,13,-1,14,15,16,17,-1,19,20,21");
	...
	setDefault(CLIENT_CHECKED_COLOUR, RGB(0, 120, 23));
	...
	setDefault(PROTECTED_USE_REGEXP, false);
	...
	setDefault(EXTRA_AIRDC_SLOTS, 2);
