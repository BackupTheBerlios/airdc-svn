...
enum Strings { // @DontAdd
	...
	SETTINGS_DOWNLOADS_EXPAND, // "Dont Group Downloads in TransferView"
	...
	MISSING_FINISHED, // "Scan finished, found %d missing release files, %d dupe folders, %d missing SFV files, %d missing NFO files and %d folders with extra files"
	SCAN_FOLDER_MISSING, // "Scan folder for missing/extra files"
	EXTRA_FILES_SAMPLEDIR, // "Extra files in Sample folder: "
	EXTRA_FILES_RLSDIR, // "Extra files in Release folder: "
