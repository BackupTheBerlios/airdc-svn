...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		DIRLIST_LEFT, DIRLIST_RIGHT, STATS_TOP, STATS_BOTTOM, STATS_LEFT, STATS_RIGHT, MAX_MCN_DOWNLOADS, PARTIAL_MATCH_ADC, NO_ZERO_BYTE, MAX_MCN_UPLOADS, MCN_AUTODETECT,
		...
		UNDERLINE_DUPES, DUPES_IN_FILELIST, DUPES_IN_CHAT, LIST_HL_BG_COLOR, LIST_HL_COLOR, LIST_HL_BOLD, LIST_HL_ITALIC, REPORT_SKIPLIST, LOG_HASHING,	SHARE_SAVE_TIME,
		USE_FTP_LOGGER,
		INT_LAST };
