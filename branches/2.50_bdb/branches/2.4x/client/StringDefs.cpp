...
"%d empty folders", 
"%d duplicate folders", 
"Extra files in Sample folder: %s", 
"The following extra files have been found from a release folder %s: %s", 
...
"The directory %s has been queued for refreshing", 
"The virtual directory %s has been queued for refreshing", 
...
"(%s of files have been added for hashing; they won't be visible in the file list until they have finished hashing)", 
"The bundle %s has been added for hashing (total size to hash: %s)", 
"Hashing finished: %d files (%s) in %d directories have been hashed in %s (%s)", 
"The directory %s has finished hashing: %d files (%s) have been hashed in %s (%s)", 
"The file %s (%s) has finished hashing in %s (%s)", 
"Hashing finished", 
"The bundle %s has been added into share", 
"Hour", 
"Hours", 
"Day", 
"Days", 
...
"Second", 
"Failed to read %s: %s", 
"Could not download the digital signature (%s)", 
"Updating failed: %s", 
"Failed to check for new version: %s", 
"Could not download the version file (%s)", 
"Could not verify the version data", 
"Could not parse the version data (%s)", 
...
"Starting to download a new client version (%s)...", 
"Update installation successful. Would you like to restart AirDC++ now to complete the update proccess?", 
...
"Failed to update the language \"%1%\" (%s)", 
...
"Failed to add the item %s: %s", 
"An item with the same name exists already", 
"%s has been searched for", 
...
"Download limit", 
"Upload limit", 
"Download limit set to %d KiB/s", 
"Upload limit set to %d KiB/s", 
...
"Hasher #%d", 
"Creating magnet link for a file %s...", 
"Magnet link was created for a file %s", 
"Hashing %s, %s left", 
...
"A %s %s was found from an user %s", 
"Favorite directory", 
