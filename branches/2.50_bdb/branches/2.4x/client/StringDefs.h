...
enum Strings { // @DontAdd
	...
	CRC_FINISHED, // "SFV check finished: there were %d files with proper checksum and %d files with invalid checksum (unable to check %d files)"
	...
	UPLOAD_LIMITS, // "Upload Limits (with auto detection)"
	...
	X_MISSING_SFV_FILES, // "%d missing SFV files"
	X_MISSING_NFO_FILES, // "%d missing NFO files"
	X_FOLDERS_EXTRAS, // "%d folders with extra files"
	X_EMPTY_FOLDERS, // "%d empty folders"
	X_DUPE_FOLDERS, // "%d duplicate folders"
	EXTRA_FILES_SAMPLEDIR_X, // "Extra files in Sample folder: %s"
	EXTRA_FILES_RLSDIR_X, // "The following extra files have been found from a release folder %s: %s"
	...
	PRIOPAGE_BALANCE_QIS, // "Also priorize the order among bundle files"
	...
	BUNDLE_MERGED, // "The bundle %s has been merged into existing bundle %s (%d items were merged)"
	X_BUNDLE_ITEMS_ADDED, // "%d items were added into an existing bundle %s"
	BUNDLE_ITEM_ADDED, // "The file %s has been added into an existing bundle %s"
	BUNDLE_MOVED, // "The bundle %s has been moved to %s"
	INSTANT_SHARING_DISABLED, // "The instant sharing feature is disabled, please add the bundle in share manually"
	NOT_IN_SHARED_DIR, // "The bundle %s isn't in a shared folder, please add it in share manually"
	...
	DIRECTORY_REFRESH_QUEUED, // "The directory %s has been queued for refreshing"
	VIRTUAL_REFRESH_QUEUED, // "The virtual directory %s has been queued for refreshing"
	...
	FILES_ADDED_FOR_HASH, // "(%s of files have been added for hashing; they won't be visible in the file list until they have finished hashing)"
	BUNDLE_ADDED_FOR_HASH,  // "The bundle %s has been added for hashing (total size to hash: %s)"
	HASHING_FINISHED_TOTAL,  // "Hashing finished: %d files (%s) in %d directories have been hashed in %s (%s)"
	HASHING_FINISHED_DIR,  // "The directory %s has finished hashing: %d files (%s) have been hashed in %s (%s)"
	HASHING_FINISHED_FILE,  // "The file %s (%s) has finished hashing in %s (%s)"
	HASHING_FINISHED_TOTAL_PLAIN, // "Hashing finished"
	BUNDLE_X_SHARED, // "The bundle %s has been added into share"
	HOUR, // "Hour"
	HOURS, // "Hours"
	DAY, // "Day"
	DAYS, // "Days"
	...
	MINUTE, // "Minute"
	SECOND, // "Second"
	FAILED_TO_READ, // "Failed to read %s: %s"
	DOWNLOAD_SIGN_FAILED, // "Could not download the digital signature (%s)"
	UPDATING_FAILED, // "Updating failed: %s"
	VERSION_CHECK_FAILED, // "Failed to check for new version: %s"
	DOWNLOAD_VERSION_FAILED, // "Could not download the version file (%s)"
	VERSION_VERIFY_FAILED,  // "Could not verify the version data"
	VERSION_PARSING_FAILED,  // "Could not parse the version data (%s)"
	...
	BACKGROUND_UPDATER_START, // "Starting to download a new client version (%s)..."
	UPDATER_RESTART, // "Update installation successful. Would you like to restart AirDC++ now to complete the update proccess?"
	...
	LANGUAGE_UPDATE_FAILED, // "Failed to update the language \"%1%\" (%s)"
	...
	AUTOSEARCH_ADD_FAILED, // "Failed to add the item %s: %s"
	ITEM_NAME_EXISTS, // "An item with the same name exists already"
	ITEM_SEARCHED, // "%s has been searched for"
	ITEM_SEARCHED_IN, // "%s will be searched in %d seconds"
	AUTO_SEARCH_SMALL, // "Auto search"
	...
	ADVANCED_UPLOAD_LIMITS, // "Advanced upload limits"
	...
	OPEN_HUB_FILELIST, // "Open hub file list (%s)"
	...
	HASHER_X, // "Hasher #%d"
	CREATING_MAGNET_FOR, // "Creating magnet link for a file %s..."
	MAGNET_CREATED_FOR, // "Magnet link was created for a file %s"
	...
	MAPPER_INIT_FAILED, // "Failed to initalize the %1% interface"
